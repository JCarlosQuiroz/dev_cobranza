(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider, EMAIL_ROUTES) {
        ...
        .state('triangular.email',  {
            ...
            views: {
                'toolbar@triangular': {
                    templateUrl: 'template/examples/email/layout/toolbar/toolbar.tmpl.html',
        ...
        angular.forEach(EMAIL_ROUTES, function(route) {
            ...
            .state(route.state, {
                ...
                views: {
                    '@triangular': {
                        templateUrl: 'template/examples/email/inbox.tmpl.html',
        ...
        angular.forEach(EMAIL_ROUTES, function(route) {
            ...
            .state(route.state + '.email', {
                url: '/mail/:emailID',
                templateUrl: 'template/examples/email/email.tmpl.html',
