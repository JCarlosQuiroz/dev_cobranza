        ...
        .state('triangular.calendar', {
            ...
            views: {
                '@triangular': {
                    ...
                    templateUrl: 'template/examples/calendar/calendar.tmpl.html',
                    // set the controller to load for this page
                    controller: 'CalendarController',
                    controllerAs: 'vm'
                },
                'toolbar@triangular': {
                    templateUrl: 'template/examples/calendar/layouts/toolbar/toolbar.tmpl.html',
                    controller: 'CalendarToolbarController',
                    controllerAs: 'vm'
                },
                'belowContent@triangular': {
                    templateUrl: 'template/examples/calendar/calendar-fabs.tmpl.html',
