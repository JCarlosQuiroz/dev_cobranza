(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.standard-page',  {
            ...
            templateUrl: 'template/examples/layouts/standard-page.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.no-scroll-page',  {
            ...
            templateUrl: 'template/examples/layouts/no-scroll-page.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.layouts-composer', {
            ...
            templateUrl: 'template/examples/layouts/composer.tmpl.html',
